...
<div class="site-wrapper">
	...
	<a class="blog-logo" href="index.html">Online Magazine</a>
	<ul id="menu">
		<li class="nav-home nav-current" role="presentation"><a href="admin/login.php">Admin Login</a></li>
		<li class="nav-article-example" role="presentation"><a href="login.php">User Login</a></li>
	...
	<header class="main-header " style="background-image: url(assets/img/mag.jpg)">
	<div class="vertical">
		<div class="main-header-content inner">
			<h1 class="page-title">Online Magazine</h1>
   ...
   <h3 style="    margin-left: 59px;"> About Us:</h3>
	<div class="wraps">
   
		<img src="assets/img/mag2.jpg"style="     margin-left: 51px;width: 39%;
    height: 100%;">
     <p style="    margin-left: 60px;"> An eMagazine, short for electronic magazine, is a digital publication that delivers content similar to traditional print magazines but in a digital format. Emagazines encompass a wide range of topics, including lifestyle, fashion, technology, travel, and more, catering to diverse interests and audiences. They often feature articles, images, videos, and interactive elements, providing readers with an engaging and immersive reading experience.</p>
		<!-- <div class="grid">
			<div class="grid-item">
				<article class="post">
